...
import { listProductDetails,reviewCreateProduct } from '../actions/productActions'
...
function ProductScreen({ match,history }) {
  ...
  const submitHandler=(e)=>{
        e.preventDefault()
        dispatch(reviewCreateProduct( match.params.id, {
            rating,
            comment
        }))
  }
            ...
            :error ? <Message variant='danger'>{error}</Message>
                ...
                <Col md={3}>
                 <ListGroup variant="flush">
                     ...
                     <ListGroup.Item>
                        <Rating value={ product.rating } text={`${product.numrating} reviews`} color={'#d9a668'} />
                     </ListGroup.Item>
                     <ListGroup.Item>
                        Price : ${product.price}
                     </ListGroup.Item>
